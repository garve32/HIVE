package com.hanwha.hive_web.config;
...
public class ServletContext {
	...
	*/
	...
	public SimpleUrlHandlerMapping xeniUrlMapping() {
		...
		suhm.setMappings(properties); return suhm;
	}
	 ...
	 * cmr.setMaxUploadSize(10240000); cmr.setMaxInMemorySize(10240000); return cmr;
	 * }
	 */
	/*
	 * @Bean public UrlBasedViewResolver urlBasedView(){ UrlBasedViewResolver
	 * urlBasedViewResolver = new UrlBasedViewResolver();
	 * urlBasedViewResolver.setOrder(1);
	 * urlBasedViewResolver.setViewClass(JstlView.class);
	 * urlBasedViewResolver.setPrefix("/WEB-INF/jsp/");
	 * urlBasedViewResolver.setSuffix(".jsp"); return urlBasedViewResolver; }
	 */

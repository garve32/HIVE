...
/**
 * <p>INF_MODL_DESC_IN_MDG complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="INF_MODL_DESC_IN_MDG"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "INF_MODL_DESC_IN_MDG", propOrder = {
    "spras",
    "maktx"
})
public class INFMODLDESCINMDG {
